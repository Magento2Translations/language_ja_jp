...
There have been  8095 strings translated of the 8467 strings in the Magento source.
...
composer require magento2translations/language_ja_jp:2.1.8.x-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_ja_jp/archive/2.1.8.zip).
